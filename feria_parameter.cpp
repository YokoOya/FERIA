...
sourceParams::sourceParams(char *outputfilename_in, double Fldres_in, double Velres_in, double distance_pc_in, double mass_msun_in, double rCB_au_in, double inc_deg_in, double PA_deg_in, double rot_sign_in, double Rout_au_in, double Rin_au_in, double HeightIRE_au_in, double FlareIRE_deg_in, double HeightKEP_au_in, double FlareKEP_deg_in, double DensCB_in, double densityProfileIRE_in, double densityProfileKEP_in, double TempCB_in, double tempProfileIRE_in, double tempProfileKEP_in, double linewidth_kmps_in, double beam_maj_as_in, double beam_min_as_in, double beam_pa_deg_in, char* name_line_in, double restfreq_GHz_in, char* name_object_in, char* radesys_in, char* center_ra_in, char* center_dec_in, double Vsys_kmps_in) {
